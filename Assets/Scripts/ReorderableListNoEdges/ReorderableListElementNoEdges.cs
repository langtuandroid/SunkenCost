...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ReorderableListElementNoEdges : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
        ...
        private ReorderableListNoEdges _currentReorderableListRaycasted;
        ...
        private ReorderableListNoEdges _displacedObjectOriginList;

        private RectTransform _rect;
        private ReorderableListNoEdges _reorderableList;
        ...
        public void BeginDrag()
        {
            ...
            if (_reorderableList.CloneDraggedObject == false)
            {
                ...
                {
                    _reorderableList.OnElementRemoved.Invoke(new ReorderableListNoEdges.ReorderableListEventStruct
                        {
            ...
            {
                _reorderableList.OnElementGrabbed.Invoke(new ReorderableListNoEdges.ReorderableListEventStruct
                    {
                        DroppedObject = _draggingObject.gameObject,
                        IsAClone = _reorderableList.CloneDraggedObject,
                        SourceObject = _reorderableList.CloneDraggedObject ? gameObject : _draggingObject.gameObject,
            ...
            IsDragging = true;
            _reorderableList.IsDragging = true;
        }
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            ReorderableListNoEdges _oldReorderableListRaycasted = _currentReorderableListRaycasted;

            //Check everything under the cursor to find a ReorderableList
            EventSystem.current.RaycastAll(eventData, _raycastResults);
            for (int i = 0; i < _raycastResults.Count; i++)
            {
                _currentReorderableListRaycasted = _raycastResults[i].gameObject.GetComponent<ReorderableListNoEdges>();
...
//                || (_oldReorderableListRaycasted != _reorderableList && !IsTransferable)
            ...
            else
            {
                ...
                /* I CHANGED THIS (j=0m childcount) */
                for (int j = 1; j < _currentReorderableListRaycasted.Content.childCount - 1; j++)
                {
        ...
        private void displaceElement(int targetIndex, Transform displaced)
        {
            ...
            var args = new ReorderableListNoEdges.ReorderableListEventStruct
            {
            ...
            if (_reorderableList.IsDropable && c < _reorderableList.maxItems && _displacedObject.GetComponent<ReorderableListElementNoEdges>().IsTransferable)
            {
            ...
            else if (_displacedObject.GetComponent<ReorderableListElementNoEdges>().isDroppableInSpace)
            {
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            IsDragging = false;
            _reorderableList.IsDragging = false;
            ...
            if (_draggingObject != null)
            {
                ...
                else
                {
                    ...
                    {
                        _reorderableList.OnElementDropped.Invoke(new ReorderableListNoEdges.ReorderableListEventStruct
                            {
                                DroppedObject = _draggingObject.gameObject,
                                IsAClone = _reorderableList.CloneDraggedObject,
                                SourceObject =
                    ...
                    if (_currentReorderableListRaycasted != null)
                    {
                            ...
                            || _currentReorderableListRaycasted.maxItems <= 0)
                        {
                            ...
                            _reorderableList.OnElementDroppedWithMaxItems.Invoke(
                                new ReorderableListNoEdges.ReorderableListEventStruct
                                {
                                    DroppedObject = o,
                                    IsAClone = _reorderableList.CloneDraggedObject,
        ...
        public void Init(ReorderableListNoEdges reorderableList)
        {
            _reorderableList = reorderableList;
            _rect = GetComponent<RectTransform>();
            
            var siblingIndex = transform.GetSiblingIndex();
            if (siblingIndex == 0 || siblingIndex == _reorderableList.Content.childCount - 1)
            {
                IsGrabbable = false;
