...
namespace UnityEngine.UI.Extensions
{
    ...
    [AddComponentMenu("UI/Extensions/Re-orderable list No Edges")]
    public class ReorderableListNoEdges : MonoBehaviour
    {
        ...
        private ReorderableListContentNoEdges _listContent;
        ...
        public void Refresh()
        {
            _listContent = ContentLayout.gameObject.GetOrAddComponent<ReorderableListContentNoEdges>();
        ...
        public struct ReorderableListEventStruct
        {
            ...
            public ReorderableListNoEdges FromList;
            public bool IsAClone;
            public GameObject SourceObject;
            public int ToIndex;
            public ReorderableListNoEdges ToList;

            public void Cancel()
            {
                SourceObject.GetComponent<ReorderableListElementNoEdges>().isValid = false;
            }
        }
